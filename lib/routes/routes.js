...
exports = module.exports = function(server, nodeManager){
  ...
  if(nodeManager) {
    ...
    server.post('/app/:appNm', function (req, res) {
      appAPI.create(req, res);
    });
    server.get ('/app/name/:appNm', function (req, res) { 
      appAPI.retrieveByName(req, res);
    });
    server.get ('/app/:appId', function (req, res) { 
      appAPI.retrieve(req, res);
    });
    server.post('/app/:appId', function (req, res) {
