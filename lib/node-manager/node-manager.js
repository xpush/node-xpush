...
NodeManager.prototype.addAppNode = function (appId, appNm, data, callback) {
  ...
  var nodePath = constants.BASE_ZNODE_PATH+constants.META_PATH+constants.APP_PATH+'/'+appInfo;
  data.id = appId;
        ...
        for (var i = 0; i < children.length; i++) {
          self.zkClient.getData(
            ...
            function (error, data, stat) {
              var appDatas = JSON.parse( data.toString('utf8'));
              console.log('appdata : ' + appDatas);
