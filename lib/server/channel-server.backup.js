...
ChannelServer.prototype.startup = function () {
  ...
  app.use(function (req, res, next) {
    ...
    console.log('-----asdfasdfasdfasdfasdfasdfasf');
  ...
  //this.io = require('socket.io').listen(this.server, {log:false, origins:'*:*'});

    //{ origins: '*' });
  //this.io.set( 'origins', '*' );
//this.io = require('socket.io').listen(this.server/*, {'flash policy port': -1}*/);
  ...
  this.io.of('/session').use(function (socket, callback) {
    ...
    console.log('handshakeData.query.app : '+handshakeData.query.app);
