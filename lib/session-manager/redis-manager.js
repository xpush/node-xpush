...
module.exports = function RedisManager(config) {
  ...
  var WRITES = [
    "del", "publish", "subscribe", "hset", "hdel", "set", "expire", "hmset", "sadd", "smembers", "hsetnx", "incr", "decr", "hincrby", "lpush", "lrem"
  ];
  ...
  var READS = [
    "hget", "hgetall", "get", "hlen", "hscan", "hexists", "mget", "exists", "rpop", "llen"
  ];
