...
SessionManager.prototype.retrieveChannelList = function(app, callback){
...
SessionManager.prototype.publish = function(server, dataObj){
  ...
  console.log('####       app : '+dataObj.app);
  console.log('####   channel : '+dataObj.channel);
  console.log('####  socketId : '+dataObj.socketId);
