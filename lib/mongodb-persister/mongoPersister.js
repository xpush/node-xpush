...
/**
 * MongoDB의 데이터를 저장, 수정, 조회를 하기 위한 module
 * @module
 * @name mongoPerister
 */
 ...
 * @param {object} input - JSON 형태의 객체
 * @param {callback} done - 등록 후 수행할 callback 함수
 */
...
/**
 * 유저 정보가 있는지 확인 후에 있는 경우 수정한다. 디바이스 Id를 필수로 입력받아
 * @name updateUser
 * @function updateUser 
 * @param {object} input - 
 * @param {callback} done - 
